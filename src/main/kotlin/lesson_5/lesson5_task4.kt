...
fun main() {
    ...
    if (signInLogin != userLogin) {
        println("Аккаунт не найден. Хотите зарегестрироваться?")
    } else if (signInLogin == userLogin) {
        println("Аккаунт найден. Введите пароль: ")
        signInPassword = readln()
